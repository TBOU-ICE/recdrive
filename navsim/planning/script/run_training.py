...
def main(cfg: DictConfig) -> None:
    ...
    trainer = pl.Trainer(**cfg.trainer.params, logger=False, callbacks=[pl.callbacks.ModelCheckpoint(monitor="val/loss_epoch",mode='min', save_top_k=5,every_n_epochs=5)])
