"""Training entry for scene-router four-teacher DiT OPD (v1). Additive file."""
...
from navsim.planning.training.agent_lightning_module_scene_router import AgentLightningSceneRouter
...
def main(cfg: DictConfig) -> None:
    ...
    lightning_module = AgentLightningSceneRouter(agent=agent)
