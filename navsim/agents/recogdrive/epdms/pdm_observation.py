# Ported verbatim from navsim_v2 (planning/simulation/planner/pdm_planner/observation/pdm_observation.py) with imports rewritten to keep the v2
...
from .pdm_occupancy_map import PDMOccupancyMap
