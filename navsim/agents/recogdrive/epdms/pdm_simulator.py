# Ported verbatim from navsim_v2 (planning/simulation/planner/pdm_planner/simulation/pdm_simulator.py) with imports rewritten to keep the v2
...
from .pdm_array_representation import ego_state_to_state_array
