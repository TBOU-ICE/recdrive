# Ported verbatim from navsim_v2 (planning/simulation/planner/pdm_planner/scoring/pdm_comfort_metrics.py) with imports rewritten to keep the v2
...
from .pdm_enums import StateIndex
