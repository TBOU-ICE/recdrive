# Ported verbatim from navsim_v2 (planning/simulation/planner/pdm_planner/scoring/pdm_scorer.py) with imports rewritten to keep the v2
# (EPDMS) scoring stack isolated from this repo's v1 modules.
import copy
...
from .pdm_dataclasses import PDMResults
from .metric_cache import MapParameters
from .pdm_observation import PDMObservation
from .pdm_occupancy_map import PDMDrivableMap
