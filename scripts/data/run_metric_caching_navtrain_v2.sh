...
export NAVSIM_DEVKIT_ROOT="/mnt/volumes/ad-e2e-bd-su01/nby/navsim_v2"
export PYTHONPATH="${NAVSIM_DEVKIT_ROOT}"
export OPENSCENE_DATA_ROOT="/mnt/datasets/recdrive/20260513/nby/recdrive/download"

CACHE_PATH="${CACHE_PATH:-/mnt/datasets/recdrive/20260513/nby/recdrive/metric_cache_train_v2}"
THREADS="${THREADS:-64}"
