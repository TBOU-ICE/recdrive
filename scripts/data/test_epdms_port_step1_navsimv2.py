...
Run with:  PYTHONPATH=/mnt/volumes/ad-e2e-bd-su01/nby/navsim_v2 python test_epdms_port_step1_navsimv2.py
...
CACHE_ROOT = Path("/mnt/datasets/recdrive/20260513/nby/recdrive/metric_cache_v2")
