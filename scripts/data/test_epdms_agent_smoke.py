...
Run:  PYTHONPATH=/mnt/volumes/ad-e2e-bd-su01/nby/recdrive-multi-opd-v1 python test_epdms_agent_smoke.py
"""
...
VIT_CACHE = Path("/mnt/datasets/simscale/20260709/new_vlm_vit_hidden_state_nav_sim")
...
V2_METRIC = "/mnt/datasets/recdrive/20260513/nby/recdrive/metric_cache_train_v2"
SIM_METRIC = "/mnt/datasets/simscale/20260709/metric_cache_synthetic_reaction_pdm_v1.0-0"
PAIR_TABLE = "/mnt/volumes/ad-e2e-bd-su01/nby/recdrive-multi-opd-v1/data/epdms/navtrain_adjacent_pairs.json"
INIT_CKPT = (
    "/mnt/models/recdrive/v1.0.0/training_dit_il_fullmix_simscale_newvlm-vit/"
