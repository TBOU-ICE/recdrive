...
export NAVSIM_DEVKIT_ROOT="${NAVSIM_DEVKIT_ROOT:-/workspace/recdrive-scene-v2}"
...
CHECKPOINT="${CHECKPOINT:-/workspace/volumes/ad-e2e-al-sh01/nby/recdrive/exp/training_dit_il_fullmix_simscale_goal_channel_newvlm/2026.08.03.14.51.54/lightning_logs/version_0/checkpoints/epoch=47-step=74928.ckpt}"
