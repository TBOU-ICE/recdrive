...
# 8-GPU PDMS eval for run_pdm_score_recogdrive (2B agent), safety_dynamics_interaction bucket.
...
CHECKPOINT="/workspace/volumes/ad-e2e-al-sh01/nby/recdrive/exp/training_recogdrive_bucket_safety_rl/2026.07.01.13.17.33/lightning_logs/version_0/checkpoints/epoch=9-step=11580.ckpt"
...
/mnt/volumes/ad-e2e-al-sh01/nby/recdrive/conda_envs/recdrive/bin/torchrun \
    ...
    experiment_name=eval-pdms-safety_dynamics_interaction-rl-epoch9 \
    worker=sequential
