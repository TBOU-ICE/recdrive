...
CHECKPOINT="/workspace/volumes/ad-e2e-al-sh01/nby/recdrive/exp/training_recogdrive_dit_opd_claude_8gpu_v3/2026.05.20.16.18.05/checkpoints/epochepoch=026-stepstep=00035000.ckpt"
...
/mnt/volumes/ad-e2e-al-sh01/nby/recdrive/conda_envs/recdrive/bin/torchrun \
    ...
    experiment_name=eval_opd_claude_v3_fix_nccl_35kstep \
    worker=sequential
