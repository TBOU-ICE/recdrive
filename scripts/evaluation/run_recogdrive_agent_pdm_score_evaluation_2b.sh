...
CHECKPOINT="/workspace/volumes/ad-e2e-al-sh01/nby/recdrive/exp/training_recogdrive_dit_opd_claude_8gpu_v3/2026.05.20.16.18.05/checkpoints/epochepoch=011-stepstep=00015000.ckpt"
...
#   --base /mnt/volumes/ad-e2e-al-sh01/nby/recdrive/InternVL3-2B \
#   --checkpoint /mnt/volumes/ad-e2e-al-sh01/nby/recdrive/exp/training_recogdrive_vlm_nby/checkpoint-400 \
#   --output /mnt/volumes/ad-e2e-al-sh01/nby/recdrive/exp/InternVL3-2B-ckpt400-merged
...
/mnt/volumes/ad-e2e-al-sh01/nby/recdrive/conda_envs/recdrive/bin/torchrun \
    ...
    experiment_name=eval_opd_claude_v3_fix_nccl_15kstep \
    worker=sequential
