...
CHECKPOINT="/workspace/volumes/ad-e2e-al-sh01/nby/training_recogdrive_dit_opd_gpt_v1/checkpoints/epochepoch=012-stepstep=00008000.ckpt"
...
/mnt/volumes/ad-e2e-al-sh01/nby/recdrive/conda_envs/recdrive/bin/torchrun \
    ...
    experiment_name=eval_opd_gpt_8ksteps \
    worker=sequential
