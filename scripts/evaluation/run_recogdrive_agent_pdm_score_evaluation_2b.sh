...
#   --base /workspace/models/recdrive/v1.0.0/InternVL3-2B \
#   --checkpoint /workspace/models/recdrive/v1.0.0/training_recogdrive_vlm_nby/checkpoint-400 \
#   --output /workspace/models/recdrive/v1.0.0/InternVL3-2B-ckpt400-merged
