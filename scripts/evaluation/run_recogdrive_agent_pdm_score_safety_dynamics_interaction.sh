...
CHECKPOINT="/workspace/volumes/ad-e2e-al-sh01/nby/recdrive/exp/training_temporal_multi_teacher_dit_opd_2b/2026.06.08.15.56.15/checkpoints/temporal-mt-epochepoch=024-stepstep=00055000.ckpt"
...
/mnt/volumes/ad-e2e-al-sh01/nby/recdrive/conda_envs/recdrive/bin/torchrun \
    ...
    experiment_name=eval-pdms-safety_dynamics_interaction-il+rl-temporal-opd \
    worker=sequential