...
SCRIPT="/mnt/volumes/ad-e2e-bd-su01/nby/recdrive-scene/scripts/evaluation/run_recogdrive_agent_pdm_score_evaluation_2b_1gpu_debug.sh"
LOG_DIR="/mnt/models/recdrive/v1.0.0/eval_recdrive"
WAIT_SECONDS=14400
