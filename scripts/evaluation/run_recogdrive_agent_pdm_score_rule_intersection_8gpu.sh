...
CHECKPOINT="/workspace/volumes/ad-e2e-al-sh01/nby/recdrive/exp/training_recogdrive_bucket_rule_direct_rl/2026.07.01.22.17.22/lightning_logs/version_0/checkpoints/epoch=9-step=10670.ckpt"
...
/mnt/volumes/ad-e2e-al-sh01/nby/recdrive/conda_envs/recdrive/bin/torchrun \
    ...
    experiment_name=eval-pdms-rule_intersection-direct-rl \
    worker=sequential
