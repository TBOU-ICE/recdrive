...
CHECKPOINT="/workspace/volumes/ad-e2e-al-sh01/nby/recdrive/exp/training_recogdrive_dit_opd_1gpu_debug-c3/2026.05.23.17.15.25/checkpoints/epochepoch=000-stepstep=00004000.ckpt"
...
/mnt/volumes/ad-e2e-al-sh01/nby/recdrive/conda_envs/recdrive/bin/torchrun \
    ...
    experiment_name=eval_opd_claude_v3_fix_nccl_1gpu_4kstep \
    worker=sequential
