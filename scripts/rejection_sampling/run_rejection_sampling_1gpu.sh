...
METRIC_CACHE_PATH="${METRIC_CACHE_PATH:-/mnt/volumes/ad-e2e-al-sh01/jiaoqf/recogdrive/metric_cache_train}"
...
python "${NAVSIM_DEVKIT_ROOT}/navsim/planning/script/run_rejection_sampling_vlm.py" \
