...
def main():
    ...
    parser.add_argument("--base_model_path", default='/workspace/volumes/ad-e2e-al-sh01/nby/recdrive/exp/InternVL3-2B-ckpt400-merged',
                        help="Path to the base HF InternVL model directory (e.g. InternVL3-2B-ckpt400-merged)")
    parser.add_argument("--opd_ckpt_path", default='/workspace/volumes/ad-e2e-al-sh01/nby/recdrive/exp/train_opd_sft_8gpu_oneimg/step00005000.pt',
                        help="Path to step*.pt saved by run_training_recogdrive_opd_sft.py")
    parser.add_argument("--output_dir", default='/workspace/volumes/ad-e2e-al-sh01/nby/recdrive/exp/InternVL3-400step-opd-step5000-merged',
