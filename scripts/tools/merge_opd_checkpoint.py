...
Usage:
    python scripts/tools/merge_opd_checkpoint.py \
        --base_model_path /mnt/models/recdrive/v1.0.0/InternVL3-2B-ckpt400-merged \
        --opd_ckpt_path   /mnt/models/recdrive/v1.0.0/train_opd_sft_8gpu_oneimg/step00002000.pt \
        --output_dir      /mnt/models/recdrive/v1.0.0/merged_model/InternVL3-2B-opd-step2000-merged
"""
...
def main():
    ...
    parser.add_argument("--base_model_path", default='/mnt/models/recdrive/v1.0.0/merged_model/InternVL3-2B-ckpt400-merged',
                        help="Path to the base HF InternVL model directory (e.g. InternVL3-2B-ckpt400-merged)")
    parser.add_argument("--opd_ckpt_path", default='/mnt/models/recdrive/v1.0.0/train_opd_sft_8gpu_oneimg/step00002000.pt',
                        help="Path to step*.pt saved by run_training_recogdrive_opd_sft.py")
    parser.add_argument("--output_dir", default='/mnt/models/recdrive/v1.0.0/merged_model/InternVL3-2B-opd-step2000-merged',
