#!/usr/bin/env bash
# Channel goal IL teacher: T4 - general_or_no_tag.
# Fresh weight-only warm-start from the goal-free fullmix IL checkpoint.
#
#   SKIP_PREP=true GPUS=8 bash scripts/training/run_recogdrive_bucket_expert_general_il_goal_channel_newvlm.sh
set -euo pipefail
