...
TEACHER_RULE_CKPT="${TEACHER_RULE_CKPT:-/workspace/volumes/ad-e2e-al-sh01/nby/recdrive/exp/training_recogdrive_bucket_rule_rl/2026.07.01.12.27.25/lightning_logs/version_0/checkpoints/epoch=9-step=10670.ckpt}"
...
/mnt/volumes/ad-e2e-al-sh01/nby/recdrive/conda_envs/recdrive/bin/torchrun \
  ...
  agent.teacher_weight_progress=0.25 \
  agent.teacher_weight_rule=0.25 \
  agent.teacher_weight_safety=0.25 \
  agent.teacher_weight_general=0.25 \
