...
INIT_CKPT="${INIT_CKPT:-/mnt/models/recdrive/v1.0.0/training_dit_il_fullmix_simscale_newvlm/2026.07.27.11.45.27/lightning_logs/version_0/checkpoints/ckpt/epoch=2-step=4683.ckpt}"
...
BUCKET_ROOT="${BUCKET_ROOT:-/mnt/datasets/simscale/20260709/data/navtrain_scene/output/navtrain}"
