...
# =============================================================================
# STANDALONE teacher trainer: T4 - general_or_no_tag (backbone / broad scenes).
# Self-contained; run on ONE 8-GPU machine (trains only this teacher):
#   GPUS=8 bash scripts/training/run_recogdrive_bucket_expert_general_rl_newvlm.sh
#
# Reward (REWARD_MODE=general): plain PDMS.
# Three weighted sampling sources: full navtrain / navtrain-general / SimScale-general
# (nav-heavy, small SimScale share to protect global metrics).
#
