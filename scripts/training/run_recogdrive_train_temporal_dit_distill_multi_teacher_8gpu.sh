...
TEACHER_IL_CKPT="${TEACHER_IL_CKPT:-/mnt/models/recdrive/v1.0.0/training_temporal_multi_teacher_dit_opd_2b/2026.06.08.15.56.15/checkpoints/temporal-mt-epochepoch=033-stepstep=00075000.ckpt}"
TEACHER_RL_CKPT="${TEACHER_RL_CKPT:-/mnt/models/recdrive/v1.0.0/training_temporal_rl_loss_2w2_continue/2026.06.07.16.32.32/checkpoints/temporal-rl-epochepoch=017-stepstep=00040000.ckpt}"
...
LOG_ROOT="${LOG_ROOT:-/mnt/volumes/ad-e2e-al-sh01/nby/training_mini_difference_comparation4}"
