...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-training_temporal_multi_teacher_dit_opd_2b}"
LOG_ROOT="${LOG_ROOT:-/workspace/volumes/ad-e2e-al-sh01/nby/training_temporal_multi_teacher_dit_opd_2b}"
