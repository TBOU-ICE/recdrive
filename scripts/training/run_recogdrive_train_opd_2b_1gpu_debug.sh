...
export NUPLAN_MAPS_ROOT="/mnt/volumes/ad-e2e-al-sh01/jiaoqf/recdrive/download/maps/nuplan-maps-v1.0"
export NAVSIM_EXP_ROOT="/mnt/volumes/ad-e2e-al-sh01/nby/recdrive/exp"
export NAVSIM_DEVKIT_ROOT="${NAVSIM_DEVKIT_ROOT:-/workspace/recdrive-opd}"
export OPENSCENE_DATA_ROOT="/mnt/volumes/ad-e2e-al-sh01/jiaoqf/recdrive/download"
...
torchrun \
    ...
    agent.opd_topk=32 \
    agent.opd_norm_to_one=True \
    agent.opd_reward_weight_mode='normalize' \
    agent.opd_use_reward_weighting=True \
    ...
    experiment_name=training_recogdrive_opd_2b_1gpu_debug \
