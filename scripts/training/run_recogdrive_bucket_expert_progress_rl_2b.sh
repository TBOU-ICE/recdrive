...
INIT_CKPT="${INIT_CKPT:-/workspace/models/recdrive/v1.0.0/ReCogDrive-2B-RL/ReCogDrive_Diffusion_Planner_2B_RL.ckpt}"
REF_CKPT="${REF_CKPT:-${INIT_CKPT}}"
BUCKET_JSON="/workspace/datasets/simscale/20260709/data/navtrain_scene/output/navtrain/exclusive_progress_curbside_stopgo_tokens.json"
