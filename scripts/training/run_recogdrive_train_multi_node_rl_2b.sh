...
export PYTHONPATH="/mnt/volumes/ad-e2e-bd-su01/nby/recdrive-multi-opd-v1:${PYTHONPATH:-}"
...
CHECKPOINT="/mnt/models/recdrive/v1.0.0/training_recogdrive_vlm_nby/2026.04.04.00.28.46/lightning_logs/version_0/checkpoints/epoch=199-step=133000.ckpt"
...
/opt/conda/envs/recdrive/bin/torchrun \
    ...
    agent.metric_cache_path="/mnt/datasets/recdrive/20260513/nby/recdrive/metric_cache_train" \
