...
# Single-GPU bucket expert IL (safety_dynamics_interaction), same recipe as
# run_recogdrive_bucket_expert_safety_il_2b.sh.
# Optional: CUDA_VISIBLE_DEVICES=0 bash run_recogdrive_bucket_expert_safety_il_1gpu.sh
...
echo "CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES} MASTER_ADDR=${MASTER_ADDR} MASTER_PORT=${MASTER_PORT}"
