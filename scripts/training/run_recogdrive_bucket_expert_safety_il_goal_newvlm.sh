...
# =============================================================================
# STANDALONE teacher trainer (STAGE-1 IL, GOAL-CONDITIONED): T1 - safety_dynamics_interaction.
# Self-contained; run on ONE 8-GPU machine (trains only this teacher):
#   GPUS=8 bash scripts/training/run_recogdrive_bucket_expert_safety_il_goal_newvlm.sh
#
# This is the imitation-learning counterpart of
# run_recogdrive_bucket_expert_safety_rl_newvlm.sh. Same bucket and the same representation
...
bucket_file = os.environ.get("MIX_BUCKET_FILE", "exclusive_safety_dynamics_interaction_tokens.json")
