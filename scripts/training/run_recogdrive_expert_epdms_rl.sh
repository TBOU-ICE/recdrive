...
VIT_CACHE_ROOT="${VIT_CACHE_ROOT:-/mnt/datasets/simscale/20260709/new_vlm_vit_hidden_state_nav_sim}"
NAV_CACHE_PATH="${NAV_CACHE_PATH:-${VIT_CACHE_ROOT}/recogdrive_agent_cache_dir_train}"
INIT_CKPT="${INIT_CKPT:-/mnt/models/recdrive/v1.0.0/training_dit_il_fullmix_simscale_newvlm-vit/version_0/checkpoints/epoch=199-step=312200.ckpt}"
REF_CKPT="${REF_CKPT:-${INIT_CKPT}}"

# ---- reward-side metric caches ----
V2_METRIC_CACHE="${V2_METRIC_CACHE:-/mnt/datasets/recdrive/20260513/nby/recdrive/metric_cache_train_v2}"
...
MIX_ROOT="${MIX_ROOT:-/mnt/datasets/simscale/20260709/data/simscale/epdms_rl_workspace/${BUCKET_NAME}}"
