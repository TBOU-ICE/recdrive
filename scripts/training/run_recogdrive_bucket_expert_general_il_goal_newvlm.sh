...
BASE_CKPT="${BASE_CKPT:-/workspace/volumes/ad-e2e-bd-su01/nby/exp/training_teacher_2epoch_base_general_or_no_tag_il_newvlm/2026.08.31.12.12.40/lightning_logs/version_0/checkpoints/epoch=199-step=118000.ckpt}"
