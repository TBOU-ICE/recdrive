#!/usr/bin/env bash
# Cross-attention goal IL teacher: T2 - rule_intersection.
# Fresh weight-only warm-start from the goal-free fullmix IL checkpoint.
#
#   SKIP_PREP=true GPUS=8 bash scripts/training/run_recogdrive_bucket_expert_rule_il_goal_cross_newvlm.sh
set -euo pipefail
...
export MASTER_PORT="${MASTER_PORT:-23772}"
