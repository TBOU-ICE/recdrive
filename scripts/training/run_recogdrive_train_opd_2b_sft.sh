...
export PYTHONPATH="/workspace/recdrive-opd-vlm${PYTHONPATH:+:${PYTHONPATH}}"
...
META_PATH="${META_PATH:-/workspace/recdrive-opd-vlm/internvl_chat/shell/data_info/recogdrive_pretrain.json}"
...
/mnt/volumes/ad-e2e-al-sh01/nby/recdrive/conda_envs/recdrive/bin/torchrun \
  ...
  --nproc_per_node=${GPUS} \
  /workspace/recdrive-opd-vlm/navsim/planning/script/run_training_recogdrive_opd_sft.py \
