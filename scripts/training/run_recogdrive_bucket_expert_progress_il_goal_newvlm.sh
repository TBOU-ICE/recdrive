...
#export BASE_CKPT="${BASE_CKPT:-/workspace/models/recdrive/v1.0.0/training_dit_il_fullmix_simscale_newvlm/2026.07.27.11.45.27/lightning_logs/version_0/checkpoints/ckpt/epoch=2-step=4683.ckpt}"
export RESUME_CKPT="${RESUME_CKPT:-/workspace/volumes/ad-e2e-bd-su01/nby/exp/training_teacher_progress_curbside_stopgo_200il_30goal_adaln_newvlm/2026.09.07.14.03.34/lightning_logs/version_0/checkpoints/epoch=97-step=45472.ckpt}"
