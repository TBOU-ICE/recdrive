...
# =============================================================================
# STANDALONE teacher trainer (STAGE-1 IL, GOAL-CONDITIONED): T3 - progress_curbside_stopgo.
# Self-contained; run on ONE 8-GPU machine (trains only this teacher):
#   GPUS=8 bash scripts/training/run_recogdrive_bucket_expert_progress_il_goal_newvlm.sh
#
# This is the imitation-learning counterpart of
# run_recogdrive_bucket_expert_progress_rl_newvlm.sh. Same bucket and the same representation
...
BASE_CKPT="${BASE_CKPT:-/workspace/volumes/ad-e2e-bd-su01/nby/exp/training_teacher_2epoch_base_progress_curbside_stopgo_il_newvlm/2026.08.31.12.14.02/lightning_logs/version_0/checkpoints/epoch=197-step=91872.ckpt}"
...
MIX_ROOT="${MIX_ROOT:-/workspace/datasets/simscale/20260709/data/simscale/il_goal_training_newvlm/${BUCKET_NAME}_fullmix}"
...
bucket_file = os.environ.get("MIX_BUCKET_FILE", "exclusive_progress_curbside_stopgo_tokens.json")
