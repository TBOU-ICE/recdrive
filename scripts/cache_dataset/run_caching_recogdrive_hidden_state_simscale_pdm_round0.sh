...
#   VLM_PATH=/workspace/volumes/ad-e2e-al-sh01/nby/recdrive/vlm_simscale_lora_merged \
...
NAVTRAIN_DATA_ROOT="${NAVTRAIN_DATA_ROOT:-/mnt/volumes/ad-e2e-al-sh01/jiaoqf/recogdrive/download}"
NAVTRAIN_EXP_ROOT="${NAVTRAIN_EXP_ROOT:-/mnt/volumes/ad-e2e-al-sh01/nby/recdrive/exp}"
...
if [[ "${VLM_PATH}" == *"ReCogDrive-VLM-2B" ]]; then
  ...
  echo "       VLM_PATH=/workspace/volumes/ad-e2e-al-sh01/nby/recdrive/vlm_simscale_lora_merged"
fi
